...
enum enumWorker
{
	...
	PROPERTY_MGR,	//Add PROPERTY_MGR for MICE2 PLUS. 20200709
...
typedef enum
{
    eDrum0=0,   //black
    eDrum1,     //Red
    //Add drum id below this line and above eDevelpoer0 if need.

    eDeveloper0,//Do NOT assign value to this item.
    //Add Developer id below this line and above eDrum_DeveloperCnt,
    //eDeveloper1,

    eDrum_DeveloperCnt,//Do NOT use this item and assign value to this enum item.
    eDrumCnt=eDeveloper0,
    eDeveloperCnt=(eDrum_DeveloperCnt-eDeveloper0),
    eToner0=0,  //black
    eToner1,    //Red
    eTonerCnt,
}enumAccessoryID;
